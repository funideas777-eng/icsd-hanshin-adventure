/**
 * DialogueScripts - ICSD × 漢神洲際冒險 所有遊戲對話腳本
 * 主題：TSMC 半導體 × 漢神洲際 × 台中地景
...
var DialogueScripts = {
  ...
  'pacman': [
    { char: '寶山工程師阿凱', avatar: '🥽', text: '歡迎來到 ICSD × 寶山的「晶圓巡禮」！我是這條 line 的製程工程師阿凱。', mood: 'excited', nameColor: '#00BCD4' },
    { char: '寶山工程師阿凱', avatar: '🥽', text: '這片晶圓鋪滿了奈米點，你的任務就是把它們全部 pickup 完成，目標良率 100%！', mood: 'happy', nameColor: '#00BCD4' },
    { char: '寶山工程師阿凱', avatar: '🥽', text: '小心那些紫色的雜質粒子！碰到等於 contamination，整片就報廢啦！', mood: 'thinking', nameColor: '#00BCD4' },
    { char: '寶山工程師阿凱', avatar: '🥽', text: '吃到金色「強化光阻」可以反殺雜質一段時間，把握住機會反擊！', mood: 'excited', nameColor: '#00BCD4' },
    { char: '寶山工程師阿凱', avatar: '🥽', text: '搞定一片就升級下一道製程，雜質會更兇喔！加油，ICSD 的精英！', mood: 'happy', nameColor: '#00BCD4' }
  ],

  'catch': [
    { char: '水果嬸', avatar: '👩‍🌾', text: '來來來！走過路過不要錯過！全全漢神最新鮮的水果都在這裡啦！', mood: 'excited', nameColor: '#FF6B35' },
  ...
  'whack': [
    ...
    { char: '王農夫', avatar: '👨‍🌾', text: '拜託你們了！要是再讓地鼠吃掉我的菜，我今年就要去漢神打工了！', mood: 'happy', nameColor: '#FF5722' }
  ],

  'memory': [
    { char: '乃哥', avatar: '🎩', text: '歡迎歡迎！我是漢神最厲害的街頭魔術師——人稱「記憶之王」的乃哥！', mood: 'excited', nameColor: '#9C27B0' },
  ...
  'shooter': [
    { char: 'EUV 對位工程師 Linda', avatar: '🔬', text: 'Hi！我是 ICSD × ASML 借調的 EUV 對位工程師 Linda。', mood: 'normal', nameColor: '#F44336' },
    { char: 'EUV 對位工程師 Linda', avatar: '🔬', text: 'EUV 光刻最關鍵的就是 alignment！對不到位，整片晶圓的圖案就糊了。', mood: 'happy', nameColor: '#F44336' },
    { char: 'EUV 對位工程師 Linda', avatar: '🔬', text: '要領是——按住瞄準先 lock-on，呼吸停穩，鬆手 shoot！像 EUV 13.5nm 一樣精準！', mood: 'excited', nameColor: '#F44336' },
    { char: 'EUV 對位工程師 Linda', avatar: '🔬', text: '連續 3 發 miss 會被當成 misalignment 警報，扣命處理！', mood: 'thinking', nameColor: '#F44336' },
    { char: 'EUV 對位工程師 Linda', avatar: '🔬', text: '來吧，讓我看看 ICSD 同仁的對位準度！中靶得分，連發更高分！', mood: 'excited', nameColor: '#F44336' }
  ],

  'dodge': [
    { char: '張博士', avatar: '👨‍🔬', text: '嗯哼，歡迎來到 ICSD 製程接力站。我是張博士，在 TSMC 跑了整整三十年的良率。', mood: 'normal', nameColor: '#00C896' },
    { char: '張博士', avatar: '👨‍🔬', text: '一片 12 吋晶圓要經過上千道製程——清洗、光刻、蝕刻、封測，每一步都不能出錯！', mood: 'thinking', nameColor: '#00C896' },
    { char: '張博士', avatar: '👨‍🔬', text: '寶山的 N2 是全球矚目的旗艦製程，每片晶圓就是台灣科技實力的縮影！', mood: 'happy', nameColor: '#00C896' },
    { char: '張博士', avatar: '👨‍🔬', text: '你的任務是當 scheduler：把晶圓依序送入四個工站的正確插槽，跑出高良率排程！', mood: 'excited', nameColor: '#00C896' },
    { char: '張博士', avatar: '👨‍🔬', text: '一片 N2 晶圓值上萬美金，放錯站或排錯順序就是廢片！集中精神，開始 dispatch！', mood: 'excited', nameColor: '#00C896' }
  ],
  ...
  'rhythm': [
    { char: 'DJ阿凱', avatar: '🎧', text: 'Yo Yo Yo！What\'s up 漢神的朋友們！我是DJ阿凱！', mood: 'excited', nameColor: '#673AB7' },
    { char: 'DJ阿凱', avatar: '🎧', text: '我在漢神的派對上放了五年的歌，從電音到嘻哈，從K-pop到台語歌，什麼都來！', mood: 'happy', nameColor: '#673AB7' },
  ...
  'photo': [
    { char: '小編 Mia', avatar: '📷', text: '同仁同仁！這次 outing 的官方攝影任務來啦——跟我們的「寶山玄彬」Simon 主管合照！', mood: 'excited', nameColor: '#FF9800' },
    { char: '小編 Mia', avatar: '📷', text: '6F 娛樂區設有 Simon 主管立牌（也可能是本人臨檢喔～），請以最帥/最美的姿勢同框！', mood: 'happy', nameColor: '#FF9800' },
    { char: '小編 Mia', avatar: '📷', text: '構圖小撇步：玄彬居中、隊員圍繞，背景帶到「ICSD × 漢神」字樣會更加分！', mood: 'thinking', nameColor: '#FF9800' },
    { char: '小編 Mia', avatar: '📷', text: '完成上傳後我會親手審核（小心我嚴格喔），通過就能拿到 300 分團隊獎勵！', mood: 'excited', nameColor: '#FF9800' }
  ],
  ...
  'photo-heart': [
    ...
    { char: '活動主持人阿明', avatar: '🎤', text: '大家手牽手，高的站後面、矮的站前面，把愛心排出來！這張照片要放在漢神的活動官網上喔！', mood: 'happy', nameColor: '#E91E63' },
    { char: '活動主持人阿明', avatar: '🎤', text: '笑開一點！我數到三就拍囉——一、二、三，漢神我愛你！', mood: 'excited', nameColor: '#E91E63' }
  ],
