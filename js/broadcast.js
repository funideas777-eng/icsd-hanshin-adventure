const Broadcast = {
  ...
  init() {
    const saved = localStorage.getItem('icsd_hanshin_broadcasts');
  ...
  save() { try { localStorage.setItem('icsd_hanshin_broadcasts', JSON.stringify({ messages: this.messages, lastTimestamp: this.lastTimestamp })); } catch {} },
